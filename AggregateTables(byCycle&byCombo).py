...
location = "/Users/unseamedwizard0/Desktop/Work/coolTurtles/src/"

def aggregateTable(leadTimes, cycles, architectures, threshold, byCycle, location):
    ...
    if byCycle == False:
        ...
        pre_aggreagete_combo_file(leadTimes, architectures, location)
...
def pre_aggreagete_combo_file(leadTimes, architectures, location):
    ...
    folder_path_origin = Path(location)
    
    folder_path =  folder_path_origin / ("_".join(architectures) + "_Combo_UQ_Files")
        ...
        for architecture in architectures:
            ...
            for combo in hyper_combos:
                ...
                for cycle in cycles:
                    ...
                    file_path = folder_path_origin / file_name
...
if __name__ == "__main__":
    ...
    aggregateTable(leadTimes, cycles, architectures, threshold, byCycle, location)
