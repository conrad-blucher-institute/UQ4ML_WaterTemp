"""
V15 Unified Plot: Scatter / Boxplot / Violin in one HTML.
...
- NEW: "Send to Time Series" button — rectangle-select dots in scatter, push to
...
def plot_unified_v15(data: pd.DataFrame, metric_column: str, output_dir: Optional[str] = None) -> Optional[str]:
