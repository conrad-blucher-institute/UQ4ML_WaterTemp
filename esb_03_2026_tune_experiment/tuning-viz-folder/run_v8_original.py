"""
Run V8 visualizations for MAPE and MSE results.

Usage:
    python run_v8.py                       # single iteration
    python run_v8.py --test-iterations 3   # duplicate run1 3x for testing 06 plot
...
def run_v8(csv_paths: list, metric_column: str, output_dir: str):
    """Load data and generate all v8 plots."""
    print(f"\n{'='*60}")
...
if __name__ == "__main__":
    ...
    for opt_type, csv_paths in OPTIMIZATION_RUNS.items():
        ...
        run_v8(
            ...
            output_dir=f"./visualizations_{opt_type}_v8",
        )
