...
def preparingData(path_to_data, input_structure, independent_year, input_hours_forecast, atp_hours_back, 
    ...
    data_year1, data_year2, data_year3, data_year4 = readingData(path_to_data)

    #verbose determines how much info we see 
    if verbose == 3:
        for i, v in enumerate([data_year1, data_year2, data_year3, data_year4]):
            print(v.columns)
    ...
    if independent_year != 'cycle':
        ...
        if independent_year == '2021':
            data_independent_year = pd.read_csv("data/ESB_datasets/esb_2024_2025.csv")
    ...
    if verbose == 3:
        for i, v in enumerate([year1, year2, year3, year4]):
            print(v.columns)
    ...
    training_data, testing_data, validation_data = splittingData(data_year1, data_year2, data_year3, data_year4, year_independent, cycle)
...
def readingData(path_to_data):
    ...
    # skip the last file; 2024_2025 is the independent here for debugging purposes
    csv_files_to_read = csv_files
