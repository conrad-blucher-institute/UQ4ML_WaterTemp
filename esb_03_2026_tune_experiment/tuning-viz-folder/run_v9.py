...
Usage:
    python run_v9.py                       # GUI folder picker
    python run_v9.py --test-iterations 3   # duplicate data 3x for testing iteration plot
...
from tuning_viz.plot_types.unified_plot_v9 import plot_unified_v9
...
def run_v9(data, metric_column, output_dir):
    """Generate all v9 plots."""
    print(f"\n{'='*60}")
    ...
    plot_unified_v9(data, metric_column, output_dir=output_dir)
    ...
    print(f"\n{'='*60}")
    print(f"All v9 plots saved to: {output_dir}")
    print(f"{'='*60}")
...
if __name__ == "__main__":
    ...
    for csv_path in csv_paths:
        ...
        run_v9(data, metric_column, output_dir)
