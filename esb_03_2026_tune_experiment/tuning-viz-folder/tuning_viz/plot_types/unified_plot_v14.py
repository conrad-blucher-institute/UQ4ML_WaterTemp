"""
V14 Unified Plot: Scatter / Boxplot / Violin in one HTML.
...
def plot_unified_v14(data: pd.DataFrame, metric_column: str, output_dir: Optional[str] = None) -> Optional[str]:
...
function sendToTimeSeries() {{
    ...
    // Open time series page
    window.open('05_timeseries.html', '_blank');
}}
