"""
V2 Iteration Comparison: best metric per iteration.
Flexible sizing with legend. Same logic, cleaned up.
"""
...
def plot_iteration_comparison_v2(data: pd.DataFrame, metric_column: str, output_dir: Optional[str] = None) -> Optional[go.Figure]:
    """
    Bar chart: best metric value per iteration.
    ...
    if output_dir:
        fig.write_html(f"{output_dir}/06_iteration_comparison_v2.html")
        print("Saved: 06_iteration_comparison_v2.html")
