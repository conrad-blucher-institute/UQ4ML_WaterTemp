        ...
        for architecture in architectures:
            ...
            for leadTime in leadTimes:
                ...
                for model in model_list:
                    ...
                    modDf2.to_csv(f"{leadTime}h_{architecture}_Cycle_{cycle}_Model_{model}.csv")
...
def decentralized_graphing_driver(architectures, leadTime, cycles, save):
    ...
    for cycle in cycles:
        ...
        for architecture in architectures:
            ...
            for model in model_list:
                ...
                df = pd.read_csv(f"{leadTime}h_{architecture}_Cycle_{cycle}_Model_{model}.csv")
    ...
    standardDeviationFan_leadTime_plot(modelsDict_cycle, leadTime, arch_title, cycle, save)
