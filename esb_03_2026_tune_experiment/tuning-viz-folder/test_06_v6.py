"""
Test the iteration stability plot (06) with synthetic 2nd run.
...
def test_iteration_comparison(csv_path: str, metric_column: str, output_dir: str):
    ...
    plot_iteration_comparison_v6(combined, metric_column, output_dir=output_dir)
    print(f"\nSaved to: {output_dir}")
...
if __name__ == "__main__":
    test_iteration_comparison(
        ...
        output_dir="./test_iteration_stability",
    )
