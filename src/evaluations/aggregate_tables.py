...
def aggregateTable(leadTimes, cycles, architectures, threshold, byCycle):
    ...
    if byCycle == False:
        ...
        pre_aggregate_combo_file(leadTimes, cycles, architectures)
            ...
            for architecture in architectures:
                ...
                for model in model_list:
                    ...
                    if byCycle == True:
                        ...
                        df = pd.read_csv("_".join(architectures) + "_Combo_UQ_Files/" + str(leadTime) + 'h_' + architecture + '_Model_' + model + ".csv")
...
def pre_aggregate_combo_file(leadTimes, cycles, architectures):
...
##END: def pre_aggregate_combo_file()
...
if __name__ == "__main__":
    ...
    architectures = ['mse']#['PNN', 'mse', 'CRPS']
