"""
V17 Time Series Comparison: model picker + triple stacked Plotly charts.

Changes from v16:
- Metric dropdown replaced with checkbox list (multi-select any/all metrics)
- Checked metrics shown as columns in the table
- Training and testing metric values displayed in chart trace labels
- Metric values shown per-model in chart annotations
...
def plot_timeseries_compare_v17(predictions_dir: str, output_dir: str) -> Optional[str]:
    ...
    html = f"""<!DOCTYPE html>
<html><head>
<title>Time Series Comparison (v17)</title>
